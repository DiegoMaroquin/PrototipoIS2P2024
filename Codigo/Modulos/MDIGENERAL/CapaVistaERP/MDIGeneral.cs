...
namespace CapaVistaERP
{
    public partial class MDIGeneral : Form
    {
        ...
        {
           Abrir(new Mantenimientos.fmr_mant_marcas());
            hideSubMenu();
        }
        ...
        {
            Abrir(new Mantenimientos.frm_Mant_cliente());
            hideSubMenu();
        }

        private void button5_Click(object sender, EventArgs e)
        {
            Abrir(new Mantenimientos.frm_mant_vendedor());
            hideSubMenu();
        }
        ...
        {
            Abrir(new Mantenimientos.frm_mant_linea());
            hideSubMenu();
        }

        private void button7_Click(object sender, EventArgs e)
        {
            Abrir(new Mantenimientos.frm_mant_producto());
            hideSubMenu();
        }
